...
public interface StreamOperator<OUT> extends CheckpointListener, KeyContext, Serializable {
    ...
    default FlexibleKeyGroupRange getFlexibleKeyGroupRange(){
        throw new UnsupportedOperationException(
                "This method is not supported in " + getClass().getSimpleName());
    }

    default Optional<Integer> getKeyGroupByKey1(StreamRecord<?> record) throws Exception {
        throw new UnsupportedOperationException(
                "This method is not supported in " + getClass().getSimpleName());
    }

    default StateBuffer collectState(List<Integer> keyGroups) throws IOException {
        throw new UnsupportedOperationException(
                "This method is not supported in " + getClass().getSimpleName());
    }

    default void mergeState(StateBuffer stateBuffer){
        throw new UnsupportedOperationException(
                "This method is not supported in " + getClass().getSimpleName());
    }
