...
public interface ResultPartitionWriter extends AutoCloseable, AvailabilityProvider {
    ...
    default void updateNumberOfSubpartitions(int newNumberOfSubpartitions,
                                             Pair<Integer,Integer> minMaxPair){
        // throw unsupported operation exception to show which class doesn't support this method
        throw new UnsupportedOperationException(
                "updateNumberOfSubpartitions is not supported in "
                        + this.getClass().getSimpleName());
    }

    default ResultPartitionType getPartitionType(){
        throw new UnsupportedOperationException(
                "getPartitionType is not supported in " + this.getClass().getSimpleName());
    }

    default void emitTriggerBarrierEvent(TriggerBarrier triggerBarrier)
            throws IOException{
        throw new UnsupportedOperationException(
