...
public class VertexInputInfoStore {
    ...
    private Map<JobVertexID, Map<IntermediateDataSetID, JobVertexInputInfo>>
    ...
    public void putOrReplace(
        ...
        checkNotNull(resultId);
        checkNotNull(info);
        // if existed: replace and return the old one
        // if not existed: put and return null
        jobVertexInputInfos.get(jobVertexId).put(resultId, info);
    }
}
