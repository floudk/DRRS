...
public class DefaultSchedulingPipelinedRegion implements SchedulingPipelinedRegion {
    ...
    public void expandPipelinedRegion(List<DefaultExecutionVertex> modifiedVertices){
        modifiedVertices.forEach(vertex-> this.executionVertices.put(vertex.getId(), vertex));
        // update nonPipelinedConsumedPartitionGroups
        checkState(nonPipelinedConsumedPartitionGroups==null
                        ||nonPipelinedConsumedPartitionGroups.isEmpty(),
                "nonPipelinedConsumedPartitionGroups is not empty");

        // update releaseBySchedulerConsumedPartitionGroups
        if( releaseBySchedulerConsumedPartitionGroups!=null){
            initializeConsumedPartitionGroups();
        }
    }
    ...
    public void updateForScale(Boolean isScaleOut,
