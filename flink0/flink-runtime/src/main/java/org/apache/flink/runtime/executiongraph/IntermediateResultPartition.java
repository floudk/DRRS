...
public class IntermediateResultPartition {
    ...
    public int refreshAndGetNumOfSubpartitions() {
        // only invoked in the upstream of scaling operator
        numberOfSubpartitions = NUM_SUBPARTITIONS_UNKNOWN;
        return getNumberOfSubpartitions();
    }
}
