 ...
 */
public class SlotSharingExecutionSlotAllocator implements ExecutionSlotAllocator {
    ...
    public LocalInputPreferredSlotSharingStrategy getSlotSharingStrategy(){
        return (LocalInputPreferredSlotSharingStrategy) slotSharingStrategy;
    }
}
