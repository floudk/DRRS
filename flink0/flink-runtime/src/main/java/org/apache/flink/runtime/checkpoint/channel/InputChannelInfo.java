...
public class InputChannelInfo implements Serializable {
    ...
    public void updateForUpstreamScaling(int newChannelIndex) {
        this.inputChannelIdx = newChannelIndex;
    }
    ...
    public void writeTo(ByteBuf header) {
        header.writeInt(gateIdx);
        header.writeInt(inputChannelIdx);
    }
    public static InputChannelInfo fromByteBuf(ByteBuf in) {
        return new InputChannelInfo(in.readInt(), in.readInt());
    }
}
