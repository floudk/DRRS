...
public class IntermediateResult {
    ...
    public void resizePartitions(int newParallelism) {
        IntermediateResultPartition[] newPartitions = new IntermediateResultPartition[newParallelism];
        System.arraycopy(this.partitions, 0, newPartitions, 0, this.partitions.length);
        this.partitions = newPartitions;

        this.numParallelProducers = newParallelism;
    }

    public List<ConsumedPartitionGroup> getShuffleDescriptorCacheKeys() {
         return new ArrayList<>(this.shuffleDescriptorCache.keySet());
    }
}
