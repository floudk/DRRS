...
import org.apache.flink.streaming.runtime.scale.SubtaskScaleHandler;
...
public abstract class StreamTask<OUT, OP extends StreamOperator<OUT>>
    ...
    // -------------------- scale related --------------------
    protected final SubtaskScaleHandler subtaskScaleHandler;
    ...
    protected StreamTask(
        ...
        try {
            ...
            this.subtaskScaleHandler =
                    new SubtaskScaleHandler<OUT>(
    ...
    protected void processInput(MailboxDefaultAction.Controller controller) throws Exception {
        ...
        switch (status) {
            ...
            case STOPPED:
                ...
                return;
            case END_OF_DATA:
                if (subtaskScaleHandler.isScaling()){
                    subtaskScaleHandler.logScaleCompleteCheck();
                }
        ...
        if (!subtaskScaleHandler.isAvailable()){
            ...
            resumeFuture = subtaskScaleHandler.getAvailableFuture();
    ...
    public final void invoke() throws Exception {
        ...
        subtaskScaleHandler.initHandler(
                mainOperator,
                getRecordScaleProcessor(),
                recordWriter,
                inputSerializer,
    ...
    protected void afterInvoke() throws Exception {
        ...
        if(subtaskScaleHandler.isScaling()){
            terminationConditions.add(subtaskScaleHandler.getScaleTerminationCondition());
        }
        ...
        LOG.info("Finished operators for task {}", getName());
    ...
    private boolean taskIsAvailable() {
        return recordWriter.isAvailable()
                ...
                &&  subtaskScaleHandler.isAvailable();
    }
    ...
    public void expandRecordWriters(ResultPartitionID resultPartitionID){
        mainMailboxExecutor.execute(
                ()->  subtaskScaleHandler.expandRecordWriters(getRecordWriterByPartitionId(resultPartitionID)),
    ...
    public void triggerScale(
        ...
        subtaskScaleHandler.triggerScale(scalingJobVertexID, upstreamJobVertexIDs, involvedKeyGroups);
    }

    // ----------------- 2. Scale Phase ---------------------------------------
     @Override
     public void onTriggerBarrier(TriggerBarrier tb, InputChannelInfo channelInfo) throws IOException {
        subtaskScaleHandler.onTriggerBarrier(tb, channelInfo);
     }
