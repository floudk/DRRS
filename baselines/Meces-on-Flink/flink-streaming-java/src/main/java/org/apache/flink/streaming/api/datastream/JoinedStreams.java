...
public class JoinedStreams<T1, T2> {
    ...
    public static class WithWindow<T1, T2, KEY, W extends Window> {
        ...
        private boolean enableHierarchicalState = false;
        ...
        public <T> DataStream<T> apply(
            ...
            coGroupedWindowedStream.enableHierarchicalState = enableHierarchicalState;
        ...
        public WithWindow<T1, T2, KEY, W>  enableHierarchicalState() {
            enableHierarchicalState = true;
            return this;
        }
    }
