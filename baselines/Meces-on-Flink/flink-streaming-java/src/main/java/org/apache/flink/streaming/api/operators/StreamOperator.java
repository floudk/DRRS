...
public interface StreamOperator<OUT> extends CheckpointListener, KeyContext, Serializable {
    ...
    default void setSubTaskScaleHandler(SubtaskScaleHandler scaleHandler){
        throw new UnsupportedOperationException(
                "This method is not supported in " + getClass().getSimpleName());
    }

    // return null if no key-partitioning state is used
    default ScalingContext.ContextInitInfo getScalingContextInitInfo(){
        throw new UnsupportedOperationException(
                "This method is not supported in " + getClass().getSimpleName());
    }

    default ScaleBuffer.StateBuffer collectState(KeyOrStateID keyOrStateID, boolean clearTimeService) throws IOException {
        throw new UnsupportedOperationException(
                "This method is not supported in " + getClass().getSimpleName());
    }

    default BitSet mergeState(ScaleBuffer.StateBuffer stateBuffer){
        throw new UnsupportedOperationException(
                "This method is not supported in " + getClass().getSimpleName());
    }
    ...
    default Tuple2<Optional<Integer>, Optional<Integer>> tryGetHieraGroupIndexByRecord(StreamRecord<?> record) throws Exception {
        throw new UnsupportedOperationException(
                "This method is not supported in " + getClass().getSimpleName());
    }
    default HierarchicalStateID getHieraStateIDByKey(Object key) {
        throw new UnsupportedOperationException(
                "This method is not supported in " + getClass().getSimpleName());
    }
}
