...
public class DefaultExecutionGraph implements ExecutionGraph, InternalExecutionGraphAccessor {
    ...
    public SubtaskAttemptNumberStore getAttemptCounts(JobVertexID vertexId){
        return this.initialAttemptCounts.getAttemptCounts(vertexId);
    }
    public Time getRpcTimeout(){
        return this.rpcTimeout;
    }
    public int getExecutionHistorySizeLimit(){
        return this.executionHistorySizeLimit;
    }
    ...
    public void expandGraph(List<ExecutionVertex> addedExecutionVertices){
        for (ExecutionVertex ev: addedExecutionVertices) {
            executionVerticesById.put(ev.getID(), ev);
            resultPartitionsById.putAll(ev.getProducedPartitions());
        }
    }

    public VertexInputInfoStore getVertexInputInfoStore() {
        return vertexInputInfoStore;
    }

    public List<Execution> getExecutionsToTrigger(){
        List<ExecutionVertex> sourceTasks = new ArrayList<>();
        getVerticesTopologically().forEach(
                jobVertex -> {
