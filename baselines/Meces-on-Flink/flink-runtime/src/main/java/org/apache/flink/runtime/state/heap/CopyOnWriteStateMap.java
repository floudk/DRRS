...
public class CopyOnWriteStateMap<K, N, S> extends StateMap<K, N, S> {
    ...
    /** The logger. */
    protected static final Logger LOG = LoggerFactory.getLogger(HeapKeyedStateBackend.class);
    ...
    // just a placeholder for the constructor
    protected CopyOnWriteStateMap(){
        this.primaryTable = null; // should not use in this constructor
        this.incrementalRehashTable = null; // should not use in this constructor
        this.snapshotVersions = null;
    ...
    class StateIncrementalVisitorImpl implements InternalKvState.StateIncrementalVisitor<K, N, S> {
        ...
        private final StateEntryChainIterator chainIterator;
        private final Collection<StateEntry<K, N, S>> chainToReturn;

        StateIncrementalVisitorImpl(int recommendedMaxNumberOfReturnedRecords) {
            chainToReturn = new ArrayList<>(5);
        ...
        // Scale Utils
        // ------------------------------------------------------------------------
        StateIncrementalVisitorImpl() {
            this.chainIterator = null;
            this.chainToReturn = null;
        }
    }
}
