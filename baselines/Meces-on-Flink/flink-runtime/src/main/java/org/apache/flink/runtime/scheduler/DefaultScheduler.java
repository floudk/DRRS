...
public class DefaultScheduler extends SchedulerBase implements SchedulerOperations {
    ...
    // SchedulerOperations
    // ------------------------------------------------------------------------
    public ExecutionSlotAllocator getExecutionSlotAllocator(){
        return executionSlotAllocator;
    }
    ...
    public DefaultExecutionDeployer getExecutionDeployer(){
        checkArgument(executionDeployer instanceof DefaultExecutionDeployer);
        return (DefaultExecutionDeployer) executionDeployer;
    }
    public  ExecutionVertexVersioner getExecutionVertexVersioner(){
