...
public class CopyOnWriteStateMapSnapshot<K, N, S>
    ...
    @Nonnegative protected int numberOfEntriesInSnapshotData;
     ...
     *     snapshot.
     */
    public CopyOnWriteStateMapSnapshot(CopyOnWriteStateMap<K, N, S> owningStateMap) {
    ...
    abstract static class SnapshotIterator<K, N, S> implements Iterator<StateEntry<K, N, S>> {
        ...
        // ------------------------------ used for HierarchicalSnapshotIterator only ------------------------------
        SnapshotIterator(){}
    }
