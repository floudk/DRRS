...
public class FlexibleKeyGroupRange extends KeyGroupRange  {
    ...
    public void remove(int keyGroupIndex){
        FlexibleKeyGroupRange temp = (FlexibleKeyGroupRange)
                FlexibleKeyGroupRange.fromIntegerList(Collections.singletonList(keyGroupIndex));
        remove(temp);
    }
    ...
    public void add(int keyGroupIndex){
