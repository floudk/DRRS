...
import org.apache.flink.streaming.runtime.scale.ScaleBarrierHandler;
...
public class OneInputStreamTask<IN, OUT> extends StreamTask<OUT, OneInputStreamOperator<IN, OUT>> {
    ...
    @Nullable private ScaleBarrierHandler scaleBarrierHandler;
    ...
    public void init() throws Exception {
        ...
        if (numberOfInputs > 0) {
            ...
            scaleBarrierHandler = new ScaleBarrierHandler(this);
            inputGate.setScaleHandler(scaleBarrierHandler);
    ...
    private StreamTaskInput<IN> createTaskInput(CheckpointedInputGate inputGate) {
        ...
        return StreamTaskNetworkInputFactory.create(
                ...
                getEnvironment().getSubtaskScaleCoordinator().getScaleStatusHolder());
    }
    ...
    private static class StreamTaskNetworkOutput<IN> implements DataOutput<IN> {
        ...
        private ThrowingBiConsumer<StreamRecord<IN>, InputChannelInfo, Exception> recordProcessorInScaling;
        private ThrowingConsumer<ScaleEvaEvent, Exception> markerForwarder;

        private StreamTaskNetworkOutput(
                Input<IN> operator,
                WatermarkGauge watermarkGauge,
                Counter numRecordsIn,
                SubtaskSubscaleHandler subtaskSubscaleHandler) {
            ...
            this.recordProcessorInScaling =
                    RecordProcessorUtils.getScalingRecordProcessor(
                            operator, subtaskSubscaleHandler, numRecordsIn);
            this.markerForwarder = subtaskSubscaleHandler::processScaleMarker;
        }
        ...
        @Override
        public void initialScaling() throws Exception{

        }

        @Override
        public void emitRecordDuringScaling(
                StreamRecord<IN> record, InputChannelInfo channel) throws Exception{
            recordProcessorInScaling.accept(record,channel);
        }
        @Override
        public void emitScaleMarker(ScaleEvaEvent scaleEvaEvent) throws Exception {
            markerForwarder.accept(scaleEvaEvent);
        }
    ...
    protected void expandInputProcessor(
        ...
        LOG.info("updateInputProcessorForUpstreamScaling in OneInputStreamTask");
        StreamOneInputProcessor oneInputProcessor = (StreamOneInputProcessor) this.inputProcessor;
        checkNotNull(oneInputProcessor,"inputProcessor is null");
        oneInputProcessor.expandOneInputProcessor(newChannelNum, addedChannelInfos, getEnvironment().getIOManager());
    }
