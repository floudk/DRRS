...
public interface PushingAsyncDataInput<T> extends AvailabilityProvider {
    ...
    interface DataOutput<T> {
        ...
        // Scale Utils
        // ---------------------------------------------------------------------
        default void initialScaling() throws Exception {
            throw new UnsupportedOperationException(
                    "This method is not supported in" + this.getClass().getSimpleName());
        }

        default void emitRecordDuringScaling(StreamRecord<T> streamRecord, InputChannelInfo channel) throws Exception{
            throw new UnsupportedOperationException(
                    "This method is not supported in" + this.getClass().getSimpleName());
        }

        default void emitScaleMarker(ScaleEvaEvent scaleEvaEvent) throws Exception {
            throw new UnsupportedOperationException(
                    "This method is not supported in" + this.getClass().getSimpleName());
        }
