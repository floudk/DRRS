...
public final class LatencyMarker extends StreamElement {
    ...
    public String emitOperatorName = "";
    public LatencyMarker(long markedTime, String emitOperatorName){
        this.markedTime = markedTime;
        this.operatorId = null;
        this.subtaskIndex = -1;
        this.customized = true;
        this.emitOperatorName = emitOperatorName;
    }
    public LatencyMarker(long markedTime, String emitOperator, long outputTime){
        this(markedTime, emitOperator);
        this.outputTime = outputTime;
    }
    public long setOutputTime(){
