...
public class TriggerBarrier extends ScaleBarrier{
    ...
    public final List<Integer> involvedKeys; // key group index involved in current subscale
    ...
    public TriggerBarrier(Map<Integer,Integer> newKeyPartition, Map<Integer, Integer> currentKeyPartition){
        super();
    ...
    public boolean equals(Object obj) {
        if (obj instanceof TriggerBarrier) {
            ...
            return involvedKeys.equals(other.involvedKeys);
        }
        return false;
    }
