...
public class RpcTaskManagerGateway implements TaskManagerGateway {
    ...
    public CompletableFuture<Acknowledge> resetSubtaskScaleCoordinator(
            ExecutionAttemptID attemptId, TaskScaleDescriptor info, Time rpcTimeout){
        return taskExecutorGateway.resetSubtaskScaleCoordinator(attemptId,info,rpcTimeout);
    }
    ...
    public CompletableFuture<Acknowledge> updateUpstreamResultPartitions(
            ...
            Time rpcTimeout){
        return taskExecutorGateway.updateUpstreamResultPartitions(
                attemptId,partitionID,newNumSubpartitions,rpcTimeout);
    }
    ...
    public CompletableFuture<Acknowledge> updateDownstreamInputGates(
            ...
            Time rpcTimeout){
        return taskExecutorGateway.updateDownstreamInputGates(attemptId,descriptor,rpcTimeout);
    }
    ...
    public CompletableFuture<Acknowledge> triggerSubscale(
        ...
        return taskExecutorGateway.triggerSubscale(attemptId,involvedKeyGroups,rpcTimeout);
    }
