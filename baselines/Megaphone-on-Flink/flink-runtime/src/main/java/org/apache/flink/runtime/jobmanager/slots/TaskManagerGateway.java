...
public interface TaskManagerGateway extends TaskExecutorOperatorEventGateway {
    ...
    CompletableFuture<Acknowledge> resetSubtaskScaleCoordinator(
            ExecutionAttemptID attemptId, TaskScaleDescriptor info, Time rpcTimeout);

    CompletableFuture<Acknowledge> updateUpstreamResultPartitions(
            ExecutionAttemptID attemptId,
            IntermediateResultPartitionID partitionID,
            int newNumSubpartitions,
            Time rpcTimeout);

    CompletableFuture<Acknowledge> updateDownstreamInputGates(
            ExecutionAttemptID attemptId,
