...
public interface TaskManagerActions {
    ...
    // ---------------------------- scale utils ----------------------------
    default void acknowledgeScaleComplete(ExecutionAttemptID executionAttemptID) {
        throw new IllegalStateException("This TaskManagerActions does not support scale actions.");
    }
