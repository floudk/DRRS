...
public abstract class NexmarkEvent extends ScaleEvaEvent {
    ...
    static public class Person extends NexmarkEvent{
        ...
        public Person perturbClone() {
            long newId = (id - NexmarkEventDeserializationSchema.random.nextInt(50)) > 0 ?
                    (id - NexmarkEventDeserializationSchema.random.nextInt(50)) : id;
            return new Person(newId, name, emailAddress, creditCard, city, state, extra);
        }
    }
    ...
    static public class Auction extends NexmarkEvent{
        ...
        public Auction perturbClone() {
            long newSeller = (seller - NexmarkEventDeserializationSchema.random.nextInt(50)) > 0 ?
                    (seller - NexmarkEventDeserializationSchema.random.nextInt(50)) : seller;
            return new Auction(id, newSeller, category, initialBid, expires, name, description, reserve, extra);
        }
