...
public class TwoInputStreamTask<IN1, IN2, OUT> extends AbstractTwoInputStreamTask<IN1, IN2, OUT> {
    ...
    protected void createInputProcessor(
        ...
        ScaleBarrierHandler scaleBarrierHandler = new ScaleBarrierHandler(this);
        for (CheckpointedInputGate checkpointedInputGate : checkpointedInputGates) {
            checkpointedInputGate.setScaleHandler(scaleBarrierHandler);
        }
