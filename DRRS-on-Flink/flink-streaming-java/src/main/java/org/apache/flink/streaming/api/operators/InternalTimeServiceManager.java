...
public interface InternalTimeServiceManager<K> {
    ...
    default void collectRawKeyedState(List<Integer> keyGroups, StateBuffer migratingState, ByteBuf byteBuf){
        throw new UnsupportedOperationException("Not support collectRawKeyedState in " + this.getClass().getSimpleName());
    }
    default void updateTimeServiceForStateMerge(StateBuffer stateBuffer){
