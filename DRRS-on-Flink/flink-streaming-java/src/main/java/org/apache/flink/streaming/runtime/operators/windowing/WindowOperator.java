...
public class WindowOperator<K, IN, ACC, OUT, W extends Window>
    ...
    public void processElement(StreamRecord<IN> element) throws Exception {
        ...
        // try set subtask index for scaling metrics
        if (element.getValue() instanceof ScaleEvaEvent){
            ((ScaleEvaEvent) element.getValue()).setSubtaskIndex(getRuntimeContext().getIndexOfThisSubtask());
        }
...
//        LOG.info("Processing time timer for key-{}, window-{}, timestamp-{}, triggerResult-{} in Thread-{}",
//                triggerContext.key, triggerContext.window, timer.getTimestamp(), triggerResult, Thread.currentThread().getName());
