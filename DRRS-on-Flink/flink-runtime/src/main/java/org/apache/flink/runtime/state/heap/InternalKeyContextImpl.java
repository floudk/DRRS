...
public class InternalKeyContextImpl<K> implements InternalKeyContext<K> {
    ...
    // any scaling operation will set this to true, and never reset it to false
    protected boolean usingFlexibleKeyGroupRange = false;
    ...
    @Override
    public boolean isUsingFlexibleKeyGroupRange(){
        return usingFlexibleKeyGroupRange;
    }
    @Override
    public FlexibleKeyGroupRange getFlexibleKeyGroupRange(){
        if (!usingFlexibleKeyGroupRange) {
            this.usingFlexibleKeyGroupRange = true;
            this.keyGroupRange = FlexibleKeyGroupRange.fromKeyGroupRange(keyGroupRange);
        }
        return (FlexibleKeyGroupRange) keyGroupRange;
    }
}
