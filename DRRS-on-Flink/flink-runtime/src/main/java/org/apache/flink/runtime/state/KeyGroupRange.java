...
public class KeyGroupRange implements KeyGroupsList, Serializable {
    ...
    public int keyGroupIndexToOffset(int keyGroupIndex) {
        if (keyGroupIndex < startKeyGroup || keyGroupIndex > endKeyGroup) {
            throw new IllegalArgumentException("keyGroupIndex " + keyGroupIndex + " is out of range [" + startKeyGroup + ", " + endKeyGroup + "]");
        }
        return keyGroupIndex - startKeyGroup;
    }
}
