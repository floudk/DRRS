...
class DefaultExecutionVertex implements SchedulingExecutionVertex {
    ...
    private List<ConsumedPartitionGroup> consumedPartitionGroups;
    ...
    public void updateConsumedPartitionGroups(List<ConsumedPartitionGroup> consumedPartitionGroups){
        this.consumedPartitionGroups = checkNotNull(consumedPartitionGroups);
    }
}
