...
public class SpillingAdaptiveSpanningRecordDeserializer<T extends IOReadableWritable>
    ...
    static final Logger LOG = LoggerFactory.getLogger(SpillingAdaptiveSpanningRecordDeserializer.class);
...
//        if (Thread.currentThread().getName().contains("max")) {
//            LOG.info("Setting next buffer with size: {}", numBytes);
//        }
