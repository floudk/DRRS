...
import org.apache.flink.runtime.scale.rest.JobScaleHandlers;
...
public class WebMonitorEndpoint<T extends RestfulGateway> extends RestServerEndpoint
    ...
    protected List<Tuple2<RestHandlerSpecification, ChannelInboundHandler>> initializeHandlers(
        ...
        final JobScaleHandlers jobScaleHandlers = new JobScaleHandlers();
        final JobScaleHandlers.ScaleTriggerHandler scaleTriggerHandler = jobScaleHandlers
                .new ScaleTriggerHandler(leaderRetriever, timeout, responseHeaders);
        final JobScaleHandlers.SubscaleTriggerHandler subscaleTriggerHandler = jobScaleHandlers
